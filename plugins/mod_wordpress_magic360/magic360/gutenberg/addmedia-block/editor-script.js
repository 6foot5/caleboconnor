(function(wpElement, wpBlocks, wpComponents, wpEditor, wpi18n){
    ...
    const store = registerStore( 'wordpress-magic360/addmedia-block', {
    ...
    registerBlockType( 'wordpress-magic360/addmedia-block', {
        title: __('Magic360'),
        description: __(''),
        icon: 'update',
        category: 'common',
        ...
        edit:  withSelect( ( select ) => {
               return {
                    shortcodes: select('wordpress-magic360/addmedia-block').receiveShortCodes(),
                };
                } )
