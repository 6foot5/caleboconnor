...
if(!defined('Magic360ModuleCoreClassLoaded')) {
    ...
    class Magic360ModuleCoreClass {
        ...
        function getHeadersTemplate($jsPath = '', $cssPath = null) {
            ...
            $headers = array();
            // add module version
            $headers[] = '<!-- Magic 360 WordPress module version v6.7.40 [v1.6.74:v4.6.8] -->';
        ...
        function loadDefaults() {
            $params = array(
				"include-headers"=>array("id"=>"include-headers","group"=>"General","order"=>"1","default"=>"No","label"=>"Include Magic360 JS & CSS","description"=>"All pages | Pages containing Magic 360","type"=>"array","subType"=>"radio","values"=>array("Yes","No"),"scope"=>"module"),
				"class"=>array("id"=>"class","group"=>"General","order"=>"20","default"=>"Magic360","label"=>"Class Name","type"=>"array","subType"=>"select","values"=>array("all","Magic360"),"scope"=>"module"),
