...
function WordPress_Magic360_send_stat($action = '') {
    ...
    if('working' == 'v6.7.40' || 'working' == 'v4.6.8') {
        return;
    }
    ...
    $path = "api/stat/?action={$action}&tool_name=magic360&license=trial&tool_version=v4.6.8&module_version=v6.7.40&platform_name=wordpress&platform_version={$platformVersion}&url={$url}";
...
function magictoolbox_WordPress_Magic360_config_page_menu() {
    if(function_exists("add_menu_page")) {
        ...
        $page = add_menu_page( __("Magic 360"), __("Magic 360"), "edit_posts", "WordPressMagic360-config-page", "WordPressMagic360_config_page", plugin_dir_url( __FILE__ )."core/admin_graphics/icon.png");
