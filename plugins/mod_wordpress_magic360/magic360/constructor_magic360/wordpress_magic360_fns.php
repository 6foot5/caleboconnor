<?php
function magictoolbox_WordPress_Magic360_set_global_variable() {
...
function magictoolbox_WordPress_Magic360_shortcode( $attrs ) {
    ...
    $html = '<a id="'.$attrs['id'].$additional_id.'" class="Magic360" data-magic360-options="'.$opt.'" href="'.$tool_start_image.'">';
